...
$htmlhead="<html>
			...
			<body>
			<h3 align=""center"">JCD Exchange Server Certificate Report</h3>"
...
$to = "ms-support@nour.net.sa"     
$from = "CertificateReport@jcd.com.sa"        
$subject = "JCD Exchange Certificate Expiration"    
$attachmentLocation = "$myDir\CertificateReport.html"     
    
$body = "<b>Dear NourNet MS-Support Team</b>, <br><br>"         
$body += "For more details about the JCD Exchange server certificate kindly find the attached report<br><br>"  
$body += "<b>Regards</b><br><br>"    
$body += "<b>JCD Exchange Server Certificate Notification</b>"  
Send-MailMessage -SmtpServer $smtp -To $to -From $from -Subject $subject -Body $body -BodyAsHtml -Attachments $attachmentLocation  